...
# print (data_train.groupby(['Sex','Survived'])['Sex'].count())
# 效果一样
print (data_train.groupby(['Sex','Survived'])['Survived'].count())

# 男女人数
print (data_train[['Sex','Survived']].groupby(['Sex']).count())
# 存活概率
print (data_train[['Sex','Survived']].groupby(['Sex']).mean())
...
print (len(dummies_Cabin.columns))
